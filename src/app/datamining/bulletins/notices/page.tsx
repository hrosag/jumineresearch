...
export default function NoticesPage() {
  ...
  const baseRows = useMemo(() => {
    ...
    // recorte por data via busca binária
    const dates = rows.map(r => r.dateMs!) // já ordenado
  ...
  // amostragem por pixel para reduzir nós SVG
...
// corpo lazy para reduzir custo da lista
