...
// ATENÇÃO: "New Issuers" agora fica em bulletins
import NewListingsPage from "./bulletins/new-listings/page";
...
export default function DataMiningPage() {
  ...
  return (
    <div className="flex h-screen">
      <aside className="ml-2 flex min-w-[48px] max-w-[400px] resize-x overflow-hidden rounded-md border border-gray-200 bg-[#1e2a38] text-white shadow-sm">
