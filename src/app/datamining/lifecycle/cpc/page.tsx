...
export default function Page() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-4 md:space-y-6 max-w-[1400px] mx-auto">
      {/* Header + ações com wrap controlado */}
      ...
      {/* Filtros em grid responsivo. Cada item w-full e min-w-0 para não estourar. */}
      <div className="grid grid-cols-1 md:grid-cols-4 xl:grid-cols-6 gap-3 md:gap-4">
        ...
        <div className="flex items-end justify-start md:justify-end min-w-0">
